...
from sksurv_importance._splitter import (
...
from sksurv_importance._utils import _any_isnan_axis0
...
class SurvivalTree(BaseEstimator, SurvivalAnalysisMixin):
    ...
    criterion = ["logrank", "weightlogrank"]
    ...
    def predict(self, X, check_input=True):
        ...
        if self.low_memory:
            ...
            # В low_memory режиме pred имеет форму (n_samples, 1) и содержит сумму CHF в моменты событий
            return pred[..., 0]
